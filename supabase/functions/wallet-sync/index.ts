...
//
// جوجل معكوسة تماماً: لا نبضة ولا سحب — نكتب الحالة الجديدة على خادمها (PUT)
// فتظهر على جهاز العميل من نفسها، ومعها messages[] التي تُرنّ جواله. لذلك فرع
// جوجل هنا يحمل المحتوى والإشعار معاً، وفرع آبل لا يحمل إلا النبضة: نصّ إشعار
// آبل مخبوز في البطاقة نفسها (changeMessage) لا في النبضة.
//
