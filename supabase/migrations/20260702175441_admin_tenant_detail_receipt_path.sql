-- admin_tenant_detail: تضمين receipt_path في اشتراكات الملعب لعرض الإيصال في صفحة المشرف.
...
begin
  ...
  from (
    select id, status, amount, requested_fields, requested_staff, payment_reference, receipt_path,
