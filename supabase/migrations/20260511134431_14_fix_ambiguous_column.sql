-- إصلاح: تأهيل اسم العمود بـ table alias لتجنب تضارب الأسماء مع OUT parameters
...
BEGIN
  ...
  FOR v_period IN
    ...
    WHERE wp.tenant_id = p_tenant_id AND wp.day_of_week = v_target_dow
...
-- نفس الإصلاح في create_pending_booking
