-- بوابة المالك (get_my_subscription_status) يجب أن تحترم suspended مثل is_tenant_active.
-- سابقًا كانت تحسب is_active من التواريخ فقط، فكان تعطيل الملعب إداريًّا يقطع صفحة
-- الحجز العامة دون لوحة المالك. الآن: التعطيل ⇒ is_active=false و phase='suspended'.
...
begin
  ...
  -- التعطيل الإداري يقطع الوصول فورًا بغضّ النظر عن التواريخ
